...
echo ""
echo "✅ VoxIQ is running at: http://localhost:${APP_PORT}"
echo "   Admin login: admin@voxiq.local / ChangeMe123!  (set ADMIN_PASSWORD in .env before real use)"
echo ""
