...
echo ""
echo "Waiting for the API to respond (public datasets + all 4 local AI models"
...
echo ""
echo "✅ CommerceIQ is running at: http://localhost:${APP_PORT}"
echo "   Admin login: admin@commerceiq.local / ChangeMe123!  (set ADMIN_PASSWORD in .env before real use)"
echo ""
