"""Model 1 — bi-encoder embeddings for retrieval.

intfloat/multilingual-e5-small: a well-established multilingual embedding
model — chosen specifically for its multilingual coverage (100+ languages
sharing one embedding space), which Lucent relies on directly for genuine
cross-lingual (English/Korean) retrieval — see etl/seed_corpus.py.
