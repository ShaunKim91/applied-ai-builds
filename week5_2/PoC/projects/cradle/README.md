...
**A local ReAct agent console with real safety guardrails** — a Week5_2 PoC, part of an AI
...
Unlike Week4's Lucent (a fixed document corpus) or Week5_1's Compass (live web search), this
