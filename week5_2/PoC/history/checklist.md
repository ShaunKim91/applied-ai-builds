...
| Not a simply-made UI | A fifth distinct nav pattern (floating pill), a third distinct 3-way type system (Quicksand/Plus Jakarta Sans/Space Mono), real pointer-reactive motion — none of which existed as a category before Week5_2 | `docs/screenshots/*.png` |
...
Separately: the guardrail check-then-execute sequence (like Week5_1 Compass's own budget check) is
