...
**A guardrailed ReAct agent console for Fenwick Mutual** — a Week5_2 PoC_v2, and a complete,
...
> 🛡️ **Shares the "Fenwick Ledger" design system with Verity** (Week5_1's companion rebuild) —
