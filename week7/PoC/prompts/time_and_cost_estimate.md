...
numbers" rule. See the Week1-6 PoCs' own `prompts/time_and_cost_estimate.md` files for the same
...
was reused verbatim from the Week2-6 PoCs, and this week needed no live-external-dependency
