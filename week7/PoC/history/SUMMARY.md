...
**Week7 PoC. Topic: agentic AI fundamentals (ReAct loop, local-LLM agents, safety guardrails).
...
## What's genuinely new this round (not reused from Weeks 1-6)
...
Complete and self-verified. Awaiting user review before proceeding to Week8.
