...
**Fenwick Mutual을 위한 가드레일 기반 ReAct 에이전트 콘솔** — Week7 PoC_v2이며, 이전 "Cradle" PoC를
...
> 🛡️ **Verity와 "Fenwick Ledger" 디자인 시스템을 공유합니다** (Week6의 짝 프로젝트) —
...
```bash
cd week7/PoC_v2/projects/threshold
./scripts/setup.sh
```
