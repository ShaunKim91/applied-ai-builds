...
echo ""
echo "Waiting for the API to respond (public datasets + all 5 local AI models"
...
echo ""
echo "✅ Parchment is running at: http://localhost:${APP_PORT}"
echo "   Admin login: admin@parchment.local / ChangeMe123!  (set ADMIN_PASSWORD in .env before real use)"
echo ""
