...
standard choice for this kind of local embedding store). Falls back
automatically to a pure-Python cosine-similarity list if chromadb fails
to import/initialize, following the same "fallback pattern" already used
throughout this project's own code, so the feature never hard-fails.
"""
import math
import threading
