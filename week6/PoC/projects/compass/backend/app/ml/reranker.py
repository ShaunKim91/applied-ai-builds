...
time) but measurably more accurate, exactly the trade-off a classic
illustrative example demonstrates with a "환불" (refund) vs "날씨" (weather)
query pair. This module is what lets Knowledge Search show a real
before/after comparison instead of just asserting reranking helps.
"""
import threading
