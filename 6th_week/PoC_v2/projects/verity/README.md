...
**A grounded claims-research assistant for Fenwick Mutual** — a Week6 PoC_v2, part of an AI
...
> deliberate design, with Threshold (Week7's companion rebuild) as one connected product suite for
...
```bash
cd 6th_week/PoC_v2/projects/verity
./scripts/setup.sh
```
...
project series' own Week1-7 PoCs, substantially hardened and extended for this round's
