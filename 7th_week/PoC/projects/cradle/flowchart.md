...
Identical to the Week1-6 PoCs — same JWT + bcrypt design, same shape-only email validator, reused
...
Reused verbatim from Week6 Compass's own daily-budget-cap pattern, applied here to the escalation
...
One step shorter than Week6 Compass's — no web-search connectivity check this week, since
