# Vibe-Coding Prompt Playbook — Cradle (Week7 PoC)

This is the prompt sequence someone could actually use — with an AI coding tool such as Claude
Code — to reproduce a project like Cradle from scratch. It mirrors the Week1-6 PoCs' own
...
> any code, name the exact structural deltas versus last week's build (Week6 "Compass"): a new
...
> governance pattern) from the most recent prior project (Week6 Compass). Write new modules only
