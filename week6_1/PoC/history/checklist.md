...
| A completely different approach from Weeks 10-14_2 and this project's own prior products | New product, new mechanism (routed LCEL turns + persisted structured memory, not a ReAct tool loop or a grounded-research pipeline), shared design system with Verity/Threshold | Whole `throughline/` tree |
