...
**A LangChain-based conversational-memory copilot for Fenwick Mutual** — a Week6_1 PoC, part of an
AI engineering project portfolio, and the third product in the "Fenwick Mutual" suite alongside
Week5_1's Verity (claims research) and Week5_2's Threshold (guarded claims-payout agent).
...
```bash
cd week6_1/PoC/projects/throughline
./scripts/setup.sh
```
