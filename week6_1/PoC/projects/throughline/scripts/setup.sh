...
echo ""
echo "Waiting for the API to respond (both local AI models download/warm up"
...
echo ""
echo "✅ Throughline is running at: http://localhost:${APP_PORT}"
echo "   Demo admin login: admin@fenwickmutual.example / ChangeMe123!  (set ADMIN_PASSWORD in .env before any real use)"
echo ""
