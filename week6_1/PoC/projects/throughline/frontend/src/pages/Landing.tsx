  ...
  return (
    <div style={{ background: "var(--page-plane)", minHeight: "100vh" }}>
      <header className="flex items-center justify-between px-6 py-4 max-w-5xl mx-auto">
        <div className="font-display font-bold text-lg">🧵 Throughline</div>
      ...
      <section className="max-w-3xl mx-auto px-6 pb-12 text-center">
        <p className="text-xs uppercase tracking-widest font-mono mb-2" style={{ color: "var(--text-muted)" }}>
          {t("landing.suite.eyebrow")}
        </p>
        <p style={{ color: "var(--text-secondary)" }}>{t("landing.suite.body")}</p>
      </section>
