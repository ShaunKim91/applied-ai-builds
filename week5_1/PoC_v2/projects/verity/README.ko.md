...
Week5_1 PoC_v2이며, 이전 "Compass" PoC를 완전히 새로 만든 상용화급 리빌드입니다. Verity는
...
> 아이덴티티 대신, 하나의 가상 회사를 위한 연결된 제품 스위트로서 Threshold(Week5_2의 짝 프로젝트)와
...
예산 상한 거버넌스 패턴 등 검증된 패턴을 이 프로젝트 시리즈 자체의 Week1-14_2 PoC들로부터
