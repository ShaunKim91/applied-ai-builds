...
| A completely different approach from Weeks 10-13 and this project's own prior Compass build | New folder (`PoC_v2`, not an edit to `PoC`), new product name, new design system, new security/observability architecture, a claims-research corpus deliberately never touching live web | Whole `verity/` tree |
